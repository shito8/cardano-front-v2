    ...
    <section className={styles.chartContainer}>
        <>
          ...
          <div className={styles.chartLegend}>
            <p className={styles.legendTitle}>{data[0].date}</p>
            <p className={styles.legendTitle}>{data[data.length / 2].date}</p>
            <p className={styles.legendTitle}>{data[data.length - 1].date}</p>
          </div>
        </>
    </section>
  );
